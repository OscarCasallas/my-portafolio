...
- **Dynamic Sections**:
  - **Projects**: Showcases my best work
...
1. Clone this repository:  
   ```bash
   git clone https://github.com/OscarCasallas/Portafolio
   ```
...
### 🎨 Designed & Developed by [**Oscar Casallas**](https://www.linkedin.com/in/oscar--casallas/)  
